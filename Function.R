...
#This code uses breaks to categoies the stream flow amounts into stages.     
  Streamflow$Stages<-cut(Streamflow$`Stream flow`, breaks = c(0,1250.0,1800.0,2450.0,3150.0,3870.0), labels=c("Not in a Flood Stage","Action Flood stage"," Minor Flood Stage","Moderate Flood Stage", "Major Flood Stage" ))
  return(Streamflow)
}
